...
<form id="ajax_form" action="../../Admin/Update_News/<?=$events[0]['e_id']?>" method="post" action="javascript:void(0)"enctype="multipart/form-data">
...
<br>
<div class="form-group">
  <button type="submit" id="button"style="float: right;" class="btn btn-success col-md-2">تعديل الحدث</button>
</div>
