...
<div class="container">
  <h2 style="text-align: center;font-family: 'El Messiri', sans-serif;">أخر التبرعات تم تخصيصها </h2>
  <br>
    ...
    <?php foreach($supportes as $support):?>
      <tr>
        ...
        <td class="td_center" id="th_height2">
            <a class="btn btn-success" href="<?php echo 'Show_one_support/'.$support['sp_id'];?>" role="button">عرض وتخصيص جديد</a>
