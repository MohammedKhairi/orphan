...
<div class="container">
  ...
  <br />
  <br />
  <script type='text/javascript' src="<?php echo base_url(); ?>assest/js/search.js"></script>
<div class="container">
  <h2 style="text-align: center;font-family: 'El Messiri', sans-serif;">أخر 10 يتيم غير مكفول تم أضافتهم الى المؤسسة</h2>
  <br>
    ...
    <?php foreach($orphans as $orphan):?>
      <tr>
        ...
        <td class="td_center" id="th_height2">
            ...
            <a class="btn btn-danger" href="<?php echo 'Delete_orphan/'.$orphan['o_id'];?>" role="button">حذف</a>
        </td>
      </tr>
      <?php endforeach;?>
    </tbody>
